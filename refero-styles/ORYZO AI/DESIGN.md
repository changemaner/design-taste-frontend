...
*Style reference only — not affiliated with, endorsed by, or sponsored by the brand. Extracted from public web pages for design study. See [README](../README.md).*
...
| Brand Gold | `#ffbf02` | `--color-brand-gold` | ORYZO logo mark and video-card wordmark — the brand's yellow, product mark only, never UI fill. |
| Cutting Mat | `#445231` | `--color-cutting-mat` | Hero-only media green (top-down craft photograph: green cutting mat, white grid). Media, not a UI surface. |
| Cork Fiber | `#b9895b` | `--color-cork-fiber` | Hero media tone of the cork coaster product photograph. Media only. |
...
### halyard-display-variable — Display and label face. Weight 500 at 51px drives display headlines with extreme uppercase confidence. Letter-spacing stays normal — the geometric forms do the work without tightening. Substitute: 'Inter', 'Söhne', or 'Neue Haas Grotesk' for close structural match. · `--font-halyard-display-variable`
...
- **Role:** Labels, nav, buttons, and display headlines — the declarative, museum-label register.

### Literata — Serif body face. The only conversational voice: 29px weight 400 mixed-case, 1.26 line-height, used for the descriptive copy that explains the product ("Designed to lift, insulate, and grip in all the right ways. Oryzo makes the simplest moment feel considered."). The italic serif also runs inside the LUSION attribution card. The family/case shift from uppercase sans label to serif mixed-case is the signal that you are reading description, not label. · `--font-literata`
- **Substitute:** 'Source Serif 4' or 'Lora'
- **Weights:** 400 (400 italic for the card tagline)
- **Sizes:** 29px
- **Line height:** 1.26
- **Role:** Body copy and attribution-card tagline — never used for headings or labels
...
| body | 29px | 1.26 | Literata 400 | `--text-body` |
...
2. LITERATA SERIF 400 — the exception, used only at 29px for the descriptive body copy that explains the product. This is the system's only conversational voice: "Designed to lift, insulate, and grip in all the right ways. Oryzo makes the simplest moment feel considered." The family shift from uppercase sans to serif mixed-case is the signal — when the text shifts from 500/UPPER to serif/mixed, the user knows they are reading description, not label.
...
:root {
  ...
  --color-brand-gold: #ffbf02;
  --color-cutting-mat: #445231;
  --color-cork-fiber: #b9895b;
  ...
  --font-literata: 'Literata', 'Source Serif 4', Georgia, serif;
