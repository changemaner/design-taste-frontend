# Apple Liquid Glass 诚实近似（Appendix C 外置）

> 触发时机：brief 要求玻璃拟态 / Apple 风 / backdrop-blur 时读；这是标注过的近似方案，非 Apple 官方实现，勿过度承诺。
...
**End.** Install commands live in `design-systems.md`; canonical docs per system: official docs (links in SKILL.md Section 2 plus `canonical-sources.md`).
